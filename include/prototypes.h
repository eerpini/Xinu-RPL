...
extern 	process	net_in(void);
extern	void	net_out(struct netpacket *nptr);
...
/* in file pdump6.c */
extern	void	pdump6(struct netpacket *);
...
extern void rad_in(void);

/* in file radioInit.c */

extern devcall	radioInit(struct dentry	*devptr);

/* in file radioIsr.c */

extern void maca_rx_callback(volatile packet_t *p);
extern void maca_tx_callback(volatile packet_t *p);

/* in file radioOut.c */

extern void rad_out(void);

/* in file radioRead.c */

extern devcall	radioRead (
        struct	dentry	*devptr,
	void	*buf,
	uint32	len);

/* in file radioWrite.c */

extern devcall	radioWrite (
	struct	dentry	*devptr,
	void	*buf,
	uint32	len);
